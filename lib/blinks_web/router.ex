defmodule BlinksWeb.Router do
  ...
  scope "/", BlinksWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{BlinksWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", BlinksWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{BlinksWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", BlinksWeb do
    ...
    live_session :current_user,
      on_mount: [{BlinksWeb.UserAuth, :mount_current_user}] do
